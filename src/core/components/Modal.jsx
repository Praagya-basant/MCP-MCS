...
/**
 * Centered dialog, spring scale+fade open/close. Stays mounted for the
 * close transition (mounted vs. visible are separate states) instead of
 * vanishing instantly, so both open and close animate.
 */
export function Modal({ open, onClose, title, children, footer, maxWidth = 'max-w-[520px]' }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        className={cn(
          'modal-panel relative w-full bg-card shadow-xl flex flex-col rounded-modal max-h-[90vh]',
