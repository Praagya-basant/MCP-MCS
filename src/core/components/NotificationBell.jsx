...
import { IconBell } from '@/core/components/icons';
import {
  listNotifications,
...
} from '@/core/notifications/notificationsApi';
import { getNotificationMeta } from '@/core/notifications/notificationMeta';
import { formatRelativeTime, groupByDay } from '@/core/utils/formatters';
...
/**
 * Bell + unread badge + 380px dropdown panel. The notification list is
 * only fetched the first time the panel opens, not on mount, so every
  ...
  return (
    <div className={cn('relative', className)} ref={ref}>
      ...
      {mounted && (
        <div
          className={cn(
            'absolute right-0 mt-1.5 w-[380px] max-w-[90vw]',
            'bg-card border border-border rounded-lg shadow-dropdown origin-top-right transition-all duration-150 ease-out flex flex-col max-h-[70vh] z-20',
