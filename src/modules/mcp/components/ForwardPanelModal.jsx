...
/** Mirrors ForwardSampleModal — see that file for the field-by-field rationale. `movement` is the panel's current open leg. */
export function ForwardPanelModal({ open, onClose, panel, movement, onSuccess }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      toast.success('Panel forwarded successfully');
      onSuccess?.();
      setSubmitting(false);
      handleClose();
    } catch (err) {
  ...
  return (
    ...
    >
      <div className="mb-6 -mt-1">
        ...
        <p className="mt-1 text-caption text-ink-muted">Currently at: {movement.destination}</p>
      </div>
