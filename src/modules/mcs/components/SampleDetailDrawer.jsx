      ...
      <Drawer open={open} onClose={onClose}>
        <div className="flex flex-col h-full min-h-0">
          <div className="relative shrink-0">
            ...
            {/* Fades the thumbnail into the info block below so the hero
                image and header content read as one continuous surface. */}
            <div className="pointer-events-none absolute inset-x-0 bottom-0 h-16 bg-gradient-to-t from-card to-transparent" />
            <span className="absolute top-3 left-3">
              <StatusBadge status={displayStatus} className="shadow-card backdrop-blur-sm" />
            </span>
            <button
              onClick={onClose}
            ...
            <div className="relative px-6 pt-2 pb-4 border-b border-border">
              ...
              <h3 className="mt-0.5 text-heading font-bold text-ink">{localSample.product_name}</h3>
          ...
          <div className="flex items-center gap-1 border-b border-border px-6 shrink-0">
            {TABS.map((t) => (
              ...
              >
                ...
                {tab === t.id && (
                  <motion.span
                    layoutId="sampleDrawerTabIndicator"
