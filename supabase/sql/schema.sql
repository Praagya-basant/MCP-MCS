...
-- ============================================================================
-- 16. DESKTOP REBUILD (supabase/migrations/0001_desktop_rebuild.sql)
-- Everything in that file, inlined here so this remains the complete,
-- current schema reference — see the migration file itself for the
-- per-change rationale comments this section omits for brevity.
-- ============================================================================
